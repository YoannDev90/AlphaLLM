...
def create_uninstall_embed(user: discord.User, bot_name: str, bot_id: int, delete_messages: bool) -> discord.Embed:
    """Créer l'embed de confirmation pour la désinstallation"""
    description = bot_descriptions.get(bot_name, "No description available.")
