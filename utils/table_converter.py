...
def clean_cell_content(cell: str) -> str:
    ...
    """
    # Supprimer le formatage markdown **gras**
    ...
    # Supprimer les émojis (caractères Unicode dans les plages d'émojis)
...
def markdown_to_ascii_table(markdown_table: str, max_line_length: int = 100) -> str:
    ...
    """
    try:
        # Étape 1: Parser les lignes du tableau markdown
        ...
        # Étape 6: Si le tableau dépasse la largeur max, redistribuer l'espace proportionnellement
        if total_natural_width > max_line_length:
            ...
            # Utiliser les largeurs naturelles si le tableau tient
        ...
        for row in rows[1:]:
            ...
            # Ajouter la ligne de séparation après chaque rangée de données
            ascii_lines.append(sep_line)
