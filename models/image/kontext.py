...
async def generate_kontext(
    prompt: str, size: str = "1024x1024", images_url: list[str] = None
) -> str:
    """
...
if __name__ == "__main__":
    prompt = (
        input(
            "Enter prompt (default: 'A mystical forest with glowing trees'): "
        ).strip()
        or "A mystical forest with glowing trees"
    )
