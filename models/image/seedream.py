...
async def generate_seedream(
    ...
    if images_url:
        logger.info(f"Adding {len(images_url)} images for seedream: {images_url}")
...
if __name__ == "__main__":
    prompt = (
        input("Enter prompt (default: 'A steampunk airship in the clouds'): ").strip()
        or "A steampunk airship in the clouds"
    )
